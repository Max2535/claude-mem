...
"use strict";var H=Object.defineProperty;var fe=Object.getOwnPropertyDescriptor;var ge=Object.getOwnPropertyNames;var Se=Object.prototype.hasOwnProperty;var he=(i,e)=>{for(var s in e)H(i,s,{get:e[s],enumerable:!0})},Re=(i,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ge(e))!Se.call(i,n)&&n!==s&&H(i,n,{get:()=>e[n],enumerable:!(t=fe(e,n))||t.enumerable});return i};var Ie=i=>Re(H({},"__esModule",{value:!0}),i);var He={};he(He,{SessionStore:()=>ee});module.exports=Ie(He);var Z=require("bun:sqlite"),Ne=require("crypto");var m=require("path"),x=require("os"),U=require("fs"),te=require("url");var Oe=null;function Ae(i){return(Oe??process.stderr.write.bind(process.stderr))(i)}function X(i){Ae(i)}var Ye=process.platform==="win32";function Le(i){return i.replace(/^\uFEFF/,"")}function P(i){return JSON.parse(Le(i))}var w="max2535",G="claude-mem-pro-max";var Je=`${G}@${w}`;var Qe=`${G}-${w}`;function ye(){return typeof __dirname<"u"?__dirname:(0,m.dirname)((0,te.fileURLToPath)(__IMPORT_META_URL__))}var ts=ye();function se(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,x.homedir)():i.startsWith("~/")?(0,m.join)((0,x.homedir)(),i.slice(2)):i}function Ce(){if(process.env.CLAUDE_MEM_DATA_DIR)return se(process.env.CLAUDE_MEM_DATA_DIR);let i=(0,m.join)((0,x.homedir)(),".claude-mem"),e=(0,m.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let s=P((0,U.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return se(t.CLAUDE_MEM_DATA_DIR)}}catch{}return i}var I=Ce(),ve=process.env.CLAUDE_CONFIG_DIR||(0,m.join)((0,x.homedir)(),".claude"),ne=(0,m.join)(ve,"plugins"),ns=(0,m.join)(ne,"marketplaces",w),rs=(0,m.join)(ne,"cache",w,G),De=(0,m.join)(I,"logs"),os=(0,m.join)(I,"settings.json"),re=(0,m.join)(I,"claude-mem.db"),Ue=(0,m.join)(I,"observer-sessions"),W=(0,m.basename)(Ue);function oe(i){(0,U.mkdirSync)(i,{recursive:!0})}var q={dataDir:()=>I,workerPid:()=>(0,m.join)(I,"worker.pid"),serverPid:()=>(0,m.join)(I,".server-beta.pid"),serverPort:()=>(0,m.join)(I,".server-beta.port"),serverRuntime:()=>(0,m.join)(I,".server-beta.runtime.json"),settings:()=>(0,m.join)(I,"settings.json"),database:()=>(0,m.join)(I,"claude-mem.db"),chroma:()=>(0,m.join)(I,"chroma"),combinedCerts:()=>(0,m.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,m.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,m.join)(I,"transcript-watch-state.json"),corpora:()=>(0,m.join)(I,"corpora"),supervisorRegistry:()=>(0,m.join)(I,"supervisor.json"),envFile:()=>(0,m.join)(I,".env"),logsDir:()=>De};var C=require("fs"),ie=require("path");var Y=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(Y||{}),V=null,K=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=q.logsDir();(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,ie.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=q.settings();if((0,C.existsSync)(e)){let s=(0,C.readFileSync)(e,"utf-8"),n=(P(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Y[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),r=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),_=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${n} ${r}:${o}:${a}.${_}`}log(e,s,t,n,r){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),a=Y[e].padEnd(5),_=s.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let u="";if(r!=null)if(r instanceof Error)u=this.getLevel()===0?`
${r.message}
${r.stack}`:` ${r.message}`;else if(this.getLevel()===0&&typeof r=="object")try{u=`
`+JSON.stringify(r,null,2)}catch{u=" "+this.formatData(r)}else u=" "+this.formatData(r);let l="";if(n){let{sessionId:h,memorySessionId:O,correlationId:S,...b}=n;Object.keys(b).length>0&&(l=` {${Object.entries(b).map(([f,v])=>`${f}=${v}`).join(", ")}}`)}let E=`[${o}] [${a}] [${_}] ${c}${t}${l}${u}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,E+`
`,"utf8")}catch(h){let O=h instanceof Error?h:new Error(String(h));X(`[LOGGER] Failed to write to log file: ${O.message}
${O.stack??""}
`)}else X(E+`
`)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}setErrorSink(e){V=e}error(e,s,t,n){this.log(3,e,s,t,n),this.routeErrorToSink(s,t,n)}routeErrorToSink(e,s,t){try{if(!V||!(t instanceof Error))return;V(t)}catch{}}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}},d=new K;var ae=require("crypto");function de(i,e,s){return(0,ae.createHash)("sha256").update([i||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Me(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function L(i){if(!i)return p;let e=Me(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function _e(i){let e=["claude","codex","cursor"];return[...i].sort((s,t)=>{let n=e.indexOf(s),r=e.indexOf(t);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:s.localeCompare(t)})}function ce(i,e,s,t,n){let r=Date.now()-t,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,s,r)??void 0}var le=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],ue=new RegExp(`<(${le.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var pe=100;function we(i){let e=Object.fromEntries(le.map(n=>[n,0]));ue.lastIndex=0;let s=0,t=i.replace(ue,(n,r)=>(e[r]=(e[r]??0)+1,s+=1,""));return s>pe&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:pe,contentLength:i.length}),{stripped:t.trim(),counts:e}}function Ee(i){return we(i).stripped}var xe=["task-notification"],Ts=new RegExp(`^\\s*<(${xe.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),bs=256*1024;var J=4e3;function B(i){let e=i.trim(),t=Ee(i).trim()||e;return t.length<=J?t:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:J}),`${t.slice(0,J-1)}\u2026`)}var Fe=require("bun:sqlite");var ke=5e3,Xe=4194304;function Pe(i){return i.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function M(i,e,s){try{i.run(e)}catch(t){let n=t instanceof Error?t:new Error(String(t));throw d.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},n),t}}function me(i,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;M(i,`PRAGMA busy_timeout = ${ke}`,"busy_timeout"),M(i,"PRAGMA foreign_keys = ON","foreign_keys"),M(i,"PRAGMA synchronous = NORMAL","synchronous"),M(i,`PRAGMA journal_size_limit = ${Xe}`,"journal_size_limit"),t&&!Pe(i)&&M(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&M(i,"PRAGMA journal_mode = WAL","journal_mode")}var Te=4096;var Ge=new Set(["set_title","set_prompt_session","remap_project"]),Be=/^(?:0|[1-9][0-9]*)$/,be=18446744073709551615n;function y(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function j(i,e={}){return typeof i!="string"||!Be.test(i)?y("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>be&&y("decimal value exceeds uint64"),e.positive&&i==="0"&&y("decimal value must be positive"),i)}function Q(i){let e=j(i);return BigInt(e)===be&&y("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function $e(i){(i===null||typeof i!="object"||Array.isArray(i))&&y("mutation must be an object");let e=i;if((typeof e.op!="string"||!Ge.has(e.op))&&y("unsupported mutation op"),e.op==="set_title"){let r=F(e,["fields","op","target"],"set_title"),o=$(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&y("set_title target requires a session identifier");for(let _ of["memory_session_id","content_session_id","platform_source"])o[_]!==void 0&&D(o[_],_);let a=F(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=F(e,["fields","op","target"],"set_prompt_session"),o=F(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");je(o.origin_device_id),j(o.origin_local_id);let a=$(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let _ of["content_session_id","platform_source","project"])a[_]!==void 0&&D(a[_],_);return}let s=F(e,["fields","op","where"],"remap_project"),t=$(s.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");t.project!==void 0&&D(t.project,"project"),t.memory_session_id!==void 0&&D(t.memory_session_id,"memory_session_id"),t.merged_into_project_is_null!==void 0&&t.merged_into_project_is_null!==!0&&y("merged_into_project_is_null may only be true"),Object.keys(t).length===0&&y("remap_project where is empty");let n=$(s.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&y("remap_project fields are empty")}function z(i){$e(i)}function je(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?y("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>Te?y(`${e} must be a non-blank string of at most ${Te} UTF-8 bytes`):i}function F(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${s} must be an object`);let t=i,n=Object.keys(t).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&y(`${s} must contain exactly: ${r.join(", ")}`),t}function $(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${s} must be an object`);let t=i,n=new Set(e),r=Object.keys(t).find(o=>!n.has(o));return r&&y(`${s} contains unknown field ${r}`),t}var ee=class{db;constructor(e=re){e instanceof Z.Database?this.db=e:(e!==":memory:"&&oe(I),this.db=new Z.Database(e)),me(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags(),this.ensureTokenUsageTables()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let r=this.getIndexColumns(n.name);return r.length===s.length&&r.every((o,a)=>o===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let n=t?L(t):void 0;return n?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `).run(s,e),s&&this.requeuePromptSync(e)}enqueueMutationOp(e,s){let t=JSON.parse(JSON.stringify(s));if(t.op==="set_prompt_session"){let n=t.target;n?.origin_device_id===null&&(n.origin_device_id="self")}z(t),this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).run((0,Ne.randomUUID)(),String(e),JSON.stringify(s),Date.now())}requeuePromptSync(e){let s=this.db.prepare(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==s&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[W];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",n.push(p,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...n).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(W),s=[],t=new Set,n={};for(let o of e){let a=L(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),t.has(o.project)||(t.add(o.project),s.push(o.project))}let r=_e(Object.keys(n));return{projects:s,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),n=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,s,t,n){return ce(this.db,e,B(s),t,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let n=[e],r="";return t&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,n.push(L(t))),n.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(s))||null:this.db.prepare(`
      ...
      ${l}
      ${E}
    `).all(...O);if(!u)return f;let v=new Map(f.map(R=>[R.id,R])),T=e.map(R=>v.get(R)).filter(R=>!!R);return n?T.slice(0,n):T}getSummaryForSession(e,s){let t=[e],n="";return s&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,n,r){let o=new Date,a=o.getTime(),_=r?L(r):p,c=B(t);n&&this.validateSetTitleMutation(e,_,n);let u=this.db.prepare(`
    ...
    `).get(p,_,e);if(u){if(s&&this.db.prepare(`
        ...
        `).run(s,u.id),n){let E=this.db.prepare("SELECT custom_title FROM sdk_sessions WHERE id = ?").get(u.id);E&&E.custom_title===null&&(this.db.prepare(`
    ...
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,n,r=0,o,a){let _=this.storeObservations(e,s,[t],null,n,r,o,a);return{id:_.observationIds[0],createdAtEpoch:_.createdAtEpoch}}storeSummary(e,s,t,n,r=0,o){let a=o??Date.now(),_=new Date(a).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n||null,r,_,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,n,r,o=0,a,_){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let E=[],h=this.db.prepare(`
        ...
        RETURNING id
      `),O=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let b of t){let N=de(e,b.title,b.narrative),f=h.get(e,s,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),r||null,o,b.agent_type??null,b.agent_id??null,N,u,c,_||null,b.metadata??null);if(f){E.push(f.id);continue}let v=O.get(e,N);if(!v)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${N}`);E.push(v.id)}let S=null;if(n){let N=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,u,c);S=Number(N.lastInsertRowid)}return{observationIds:E,summaryId:S,createdAtEpoch:c}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",_=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],E=[];r&&(E.push("(ss.project = ? OR ss.merged_into_project = ?)"),l.push(r,r)),o&&(E.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let h=E.length>0?`AND ${E.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT ss.*
      ...
      ${_}
      ${c}
    `).all(...l);if(!a)return S;let b=new Map(S.map(f=>[f.id,f])),N=e.map(f=>b.get(f)).filter(f=>!!f);return n?N.slice(0,n):N}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",_=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],E=[];r&&(E.push("s.project = ?"),l.push(r)),o&&(E.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let h=E.length>0?`AND ${E.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${_}
      ${c}
    `).all(...l);if(!a)return S;let b=new Map(S.map(f=>[f.id,f])),N=e.map(f=>b.get(f)).filter(f=>!!f);return n?N.slice(0,n):N}getTimelineAroundTimestamp(e,s=10,t=10,n,r){return this.getTimelineAroundObservation(null,e,s,t,n,r)}getTimelineAroundObservation(e,s,t=10,n=10,r,o){let a=o?L(o):void 0,_=(T,R,g=!1)=>{let A=[],k=[];return r&&(g?(A.push(`(${T}.project = ? OR ${T}.merged_into_project = ?)`),k.push(r,r)):(A.push(`${T}.project = ?`),k.push(r))),a&&(A.push(`COALESCE(NULLIF(${R}.platform_source, ''), '${p}') = ?`),k.push(a)),{clause:A.length>0?`AND ${A.join(" AND ")}`:"",params:k}},c=_("o","src",!0),u=_("ss","src",!0),l=_("s","s"),E,h;if(e!==null){let T=`
      ...
      `,R=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let g=this.db.prepare(T).all(e,...c.params,t+1),A=this.db.prepare(R).all(e,...c.params,n+1);if(g.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};E=g.length>0?g[g.length-1].created_at_epoch:s,h=A.length>0?A[A.length-1].created_at_epoch:s}catch(g){return g instanceof Error?d.error("DB","Error getting boundary observations",{project:r},g):d.error("DB","Error getting boundary observations with non-Error",{},new Error(String(g))),{observations:[],sessions:[],prompts:[]}}}else{let T=`
      ...
      `,R=`
        ...
        LIMIT ?
      `;try{let g=this.db.prepare(T).all(s,...c.params,t),A=this.db.prepare(R).all(s,...c.params,n+1);if(g.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};E=g.length>0?g[g.length-1].created_at_epoch:s,h=A.length>0?A[A.length-1].created_at_epoch:s}catch(g){return g instanceof Error?d.error("DB","Error getting boundary timestamps",{project:r},g):d.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(g))),{observations:[],sessions:[],prompts:[]}}}let O=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
