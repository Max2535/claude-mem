 ...
 */
export type RouteId = 'home' | 'recall' | 'explorer' | 'burn' | 'flow' | 'chat' | 'system';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    id: 'flow',
    label: 'Agent Flow',
    icon: 'M5 5h4v4H5zM15 5h4v4h-4zM10 15h4v4h-4zM9 7h6M7 9v3a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V9M12 13v2',
    built: true,
  },
  {
    id: 'chat',
